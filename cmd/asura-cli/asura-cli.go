...
import (
	...
	servertest "github.com/teragrid/asura/tests/server"
...
var RootCmd = &cobra.Command{
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		if client == nil {
			var err error
			client, err = asuracli.NewClient(flagAddress, flagAbci, false)
			if err != nil {
				return err
			}
...
var dummyCmd = &cobra.Command{
	Use:        "dummy",
	Deprecated: "use: [asura-cli kvstore] instead",
	Short:      "Asura demo example",
	Long:       "Asura demo example",
	Args:       cobra.ExactArgs(0),
	RunE: func(cmd *cobra.Command, args []string) error {
...
func muxOnCommands(cmd *cobra.Command, pArgs []string) error {
	if len(pArgs) < 2 {
		return errors.New("expecting persistent args of the form: asura-cli [command] <...>")
	}
