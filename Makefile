...
docker_build:
	docker build -t "teragrid/asura-dev" -f Dockerfile.develop .

docker_run:
	docker run -it -v "$(CURDIR):/go/src/github.com/teragrid/asura" -w "/go/src/github.com/teragrid/asura" "teragrid/asura-dev" /bin/bash

docker_run_rm:
	docker run -it --rm -v "$(CURDIR):/go/src/github.com/teragrid/asura" -w "/go/src/github.com/teragrid/asura" "teragrid/asura-dev" /bin/bash

devdoc_init:
	docker run -it -v "$(CURDIR):/go/src/github.com/teragrid/asura" -w "/go/src/github.com/teragrid/asura" teragrid/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	docker run -it -v "$(CURDIR):/go/src/github.com/teragrid/asura" -w "/go/src/github.com/teragrid/asura" devdoc:local bash
